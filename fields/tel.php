...
?>
<div class="field_tel cs_field">
    <span class="field_label">
        <?php echo esc_html($list_attr['label']); ?>
        <?php echo !empty($required) ? '<i class="icon_required">*</i>': '';?>
    </span>
    <div class="main_field">
        <input class="<?php echo esc_attr($list_attr['class_field']); ?>" type="tel" name="<?php echo esc_attr($list_attr['name']); ?>" placeholder="<?php echo esc_attr($list_attr['placeholder']); ?>" value="<?php echo esc_attr($value); ?>" <?php echo $required; ?> />
    </div>
